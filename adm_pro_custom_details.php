...
<div><h2><?php _e( 'Property Information', 'wp-realestate' ); ?></h2>
<div class="AdmfrmLabel">
...
<div class="AdmfrmFld">
  <select id="et_er_adtype" name="et_er_adtype" class="AdmFrmList">
    <option <?php if ($et_er_adtype == __( 'Sale', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Sale', 'wp-realestate' ); ?></option>
    <option <?php if ($et_er_adtype == __( 'Rent', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Rent', 'wp-realestate' ); ?></option>
  </select>
</div>
<br style="clear:both;" />
<div class="AdmfrmLabel">
...
<div class="AdmfrmFld">
  <select name="et_er_furnishing" id="et_er_furnishing" class="AdmFrmList">
    <option <?php if ($et_er_furnishing == __( 'Not Applicable', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Not Applicable', 'wp-realestate' ); ?></option>
    <option <?php if ($et_er_furnishing == __( 'Unfurnished', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Unfurnished', 'wp-realestate' ); ?></option>
    <option <?php if ($et_er_furnishing == __( 'Semi Furnished', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Semi Furnished', 'wp-realestate' ); ?></option>
    <option <?php if ($et_er_furnishing == __( 'Fully Furnished', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Fully Furnished', 'wp-realestate' ); ?></option>
  </select>
</div>
<br style="clear:both;" />
<div class="AdmfrmLabel">
...
<div class="AdmfrmFld">
  <select name="et_er_tenure" id="et_er_tenure" class="AdmFrmList">
    <option <?php if ($et_er_tenure == __( 'Not Applicable', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Not Applicable', 'wp-realestate' ); ?></option>
    <option <?php if ($et_er_tenure == __( 'Freehold', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Freehold', 'wp-realestate' ); ?></option>
    <option <?php if ($et_er_tenure == __( 'Leasehold', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Leasehold', 'wp-realestate' ); ?></option>
  </select>
</div>
<br style="clear:both;" />
<div class="AdmfrmLabel">
...
<div class="AdmfrmFld">
  <select name="p_cons_year" class="cstm_s_big" id="p_cons_year">
    <option <?php if ($et_er_cons_year == __( 'Not Applicable', 'wp-realestate' )) {?> selected="selected"<?php }?>><?php _e( 'Not Applicable', 'wp-realestate' ); ?></option>
                    <?php 
					$yr = date('Y');
					for ($x=1960; $x<=$yr; $x++){ ?>
